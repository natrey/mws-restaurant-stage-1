...
var fetchRestaurantFromURL = function fetchRestaurantFromURL(callback) {
  ...
  if (!id) {
    ...
    _dbhelper2.default.getRestaurantById(id, function (error, restaurant) {
...
var fillRestaurantHTML = function fillRestaurantHTML() {
  ...
  var name = document.querySelector('.restaurant__name');
  name.innerHTML = restaurant.name;

  var address = document.querySelector('.restaurant__address');
  ...
  var source = document.querySelector('.restaurant source');
  source.srcset = _dbhelper2.default.imageUrlForRestaurant(restaurant);

  var cuisine = document.querySelector('.restaurant__cuisine');
...
var fillRestaurantHoursHTML = function fillRestaurantHoursHTML() {
  ...
  var hours = document.querySelector('.restaurant__hours');
